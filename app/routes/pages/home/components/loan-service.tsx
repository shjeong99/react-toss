    ...
    <section className="h-auto desktop:h-[1326px]">
      <div className="container flex flex-col py-[100px] desktop:flex-row desktop:pt-[250px]">
        <div>
          ...
          {isMobile && (
            <InDropUp className="relative h-[585px] w-[375px]">
              <img
                className="absolute top-[70px] left-[100px] w-[213px]"
                src="/images/loan-service.png"
                alt="load-service"
              />
              <img
                className="relative left-[20px] w-[375px]"
          ...
          <div style={{ color: 'rgb(51, 61, 75)' }}>
            <div ref={ref}>
              <motion.h2
                className="text-[28px] leading-[1.5] font-[700] desktop:text-[48px]"
              ...
              <motion.h2
                className="mb-[30px] text-[28px] leading-[1.5] font-[700] desktop:text-[48px]"
                initial={{ opacity: 0, y: 40 }}
                animate={isInView ? { opacity: 1, y: 0 } : {}}
            ...
            <InDropUp className="text-[17px] leading-[1.5] font-[600] desktop:text-[23px]">
